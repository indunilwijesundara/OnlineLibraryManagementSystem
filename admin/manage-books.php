                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tb_upload.name,tblcategory.CategoryName,tblauthors.AuthorName,tb_upload.isbn,tb_upload.image,tb_upload.id as bookid from  tb_upload join tblcategory on tblcategory.id=tb_upload.category join tblauthors on tblauthors.id=tb_upload.author";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->BookImage);?></td>
                                            <td class="center">
