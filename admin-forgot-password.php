...
echo "<script>alert('Email id or User name no is invalid',$email);</script>"; 
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form role="form" name="chngpwd" method="post" onSubmit="return valid();">
                                ...
                                <button type="submit" name="change" class="btn btn-info">Chenge Password</button> | <a
                                    href="adminlogin.php">Login</a>
                            </form>
                        </div>
                    </div>
                </div>
