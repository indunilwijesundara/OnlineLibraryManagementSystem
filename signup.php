...
<select class="form-control" name="faculty" id="faculty" autocomplete="off" required>
...
<select class="form-control" name="department" id="department" autocomplete="off" required>
